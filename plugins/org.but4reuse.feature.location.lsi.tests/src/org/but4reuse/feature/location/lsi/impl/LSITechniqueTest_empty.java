...
class LSITechniqueTest_empty {
	...
	/**
	 * Order of terms of the exercise
	...
	void emptyApplyLSIwithInstance() {
		...
		double[] answer = lsiTechnique.applyLSI(query, documents, LSITechnique.FIXED, 2.0, false, 0);
	...
	void emptyApplyLSIwithoutLowerRankAproximation() {
		...
		double[] answer = lsiTechnique.applyLSI(query, documents, LSITechnique.FIXED, 2.0, true, 8);
