 ...
 *
 */
class LSITechniqueTest_controlabillity {
	...
	void controlabillityApplyLSIwithInstance() {
		...
		terms.add("controllability");
		terms.add("observability");
		terms.add("realization");
		terms.add("feedback");
		terms.add("controller");
		terms.add("observer");
		terms.add("transferfunction");
		...
		LSITechnique lsiTechnique = new LSITechnique(documents, LSITechnique.FIXED, 2, LSITechnique.PREDIFINED_SORT,
				terms);
		double[] answer = lsiTechnique.applyLSI(query, documents, LSITechnique.FIXED, 2.0, true, 2);
	...
	@Test
	void controlabillityApplyLSIwithoutLowerRankAproximation() {
		// Step 0 Set Up the variables
		setUp();

		// Step 1 Get similarity between the query and the documents
		LSITechnique lsiTechnique = new LSITechnique();
		double[] answer = lsiTechnique.applyLSI(query, documents, LSITechnique.FIXED, 2.0, false, 4);
