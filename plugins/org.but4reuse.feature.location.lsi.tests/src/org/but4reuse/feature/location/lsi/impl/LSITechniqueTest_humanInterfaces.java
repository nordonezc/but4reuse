 ...
 *
 */
class LSITechniqueTest_humanInterfaces {
	...
	void humanInterfaceApplyLSIwithFixedAndPredefinedSort() {
		...
		LSITechnique lsiTechnique = new LSITechnique(documents, LSITechnique.FIXED, 2.0, LSITechnique.PREDIFINED_SORT,
				terms);
	...
	void humanInterfaceApplyLSIwithoutLowerRankAproximation() {
		...
		double[] answer = lsiTechnique.applyLSI(query, LSITechnique.FIXED, 2.0);
